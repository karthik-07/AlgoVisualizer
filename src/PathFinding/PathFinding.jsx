  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button  type="button" variant="outlined" color="secondary" onClick={() => this.clearGrid()}>
        Clear Grid
        </Button>
        <Button  type="button" variant="outlined" color="secondary" onClick={() => this.clearWalls()}>
        Clear Walls
        </Button>
        ...
        {this.state.isDesktopView ? (
            ...
            <Button type="button" variant="outlined" onClick={() => this.toggleView()}>Desktop View</Button>
        )}
        </div>
      </div>
    );
